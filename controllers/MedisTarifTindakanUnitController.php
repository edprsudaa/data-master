    ...
    { 
        ...
        if($kode_kelas == 'all'){
            ...
            foreach($kelasRawat  as $kelas){
                ...
                $getTarifTindakanId = $modelTarifTindakan->find()->where(['and',['tindakan_id' => $tarif_tindakan_id],['kelas_rawat_kode'=>$kelas->kode]])->one();
            ...
            return [
                    ...
                    'data'  => $getTarifTindakanId
                ];


        }else{
            $getTarifTindakanId = $modelTarifTindakan->find()->where(['and',['tindakan_id' => $tarif_tindakan_id],['kelas_rawat_kode'=>$kode_kelas]])->one();
